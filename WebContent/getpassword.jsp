      ...
      <div class="site-wrapper-inner">
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">通过邮箱找回密码</h1></br>
            <form class="navbar-form navbar-center" role="login">
                 <input type="text" class="form-control " placeholder="请输入邮箱"></br></br>
                 <button type="button" class="btn btn-primary btn-lg">找回密码</button>
             </form>
             <h5><a href="login.html">登录</a></h5>
